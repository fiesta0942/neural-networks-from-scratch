...
# 1. Load Dataset
X, Y = make_moons (n_samples = 1000, noise = 0.2, random_state = 42)        #반달 모양의 데이터셋
...
X_train = X_train.T             # (2,800), 2개의 feature with 800 samples
...
plt.show()                      # Note that it needs curved Decision Boundary, hence logistic regression does NOT work
...
# Input data X는 2 x 800 matrix. 그래서 Input Layer도 2개여야함
